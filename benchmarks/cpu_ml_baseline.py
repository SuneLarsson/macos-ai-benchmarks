...
def benchmark_cpu(iterations=1000, seed=42, prefix=""):
    np.random.seed(seed)
    ...
    filename = f"results/{filename_prefix}cpu_stats_{int(time.time())}.json"
...
if __name__ == "__main__":
    ...
    benchmark_cpu(iterations=args.runs, seed=args.seed)
